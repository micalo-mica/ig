  ...
  return (
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
        ...
        <div onClick={()=>router.push("/")} className="relative hidden lg:inline-grid  w-24">
            <Image src="https://links.papareact.com/ocw" alt="" layout="fill"
            objectFit="contain" 
            />
        </div>
        <div onClick={()=>router.push("/")} className="relative w-10  lg:hidden flex-shrink-0 cursor-pointer">
            <Image src="https://links.papareact.com/jjm" alt="" layout="fill"
            objectFit="contain" 
            />
        </div>
        ...
        <img onClick={signOut} sur={session.user.image} alt="profile pic"
